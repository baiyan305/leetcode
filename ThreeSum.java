...
public class ThreeSum {
	...
	public static List<List<Integer>> threeSum(int[] nums) {
		...
		kSum(lists, new ArrayList<>(), nums, 0, 3, 0);
		
		return lists;
    }
	
	private static void kSum(List<List<Integer>> lists, List<Integer> list, int[] nums, int start, int k, int target) {
		if(k == 2) {
	...
	private static void twoSum(List<List<Integer>> lists, List<Integer> list, int[] nums, int start, int target) {
